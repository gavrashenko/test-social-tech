...
describe('WebSocketManager', () => {
  it('WebSocket reconnect', async () => {
    ...
    const whenSocketDisconnect = async () => new Promise(async (res) => {
    ...
    const connectingOnServer = async () => new Promise(async (res) => {
  ...
  it('WebSocket message sending', async () => {
    ...
    const whenServerSendMessage = async () => new Promise(async (res) => {
